...
# Добавляем флаги для VDVAE
flags.DEFINE_enum("encoder_type", 'SeparableEncoderVGG19ml', ['SeparableEncoderVGG19ml', 'BaseEncoderVGG19ml', 'VDVAEEncoderBase', 'VDVAEEncoderRGBD'], 'Тип используемого энкодера')
flags.DEFINE_string("vdvae_weights", '', 'Путь к предобученным весам VDVAE')

flags.DEFINE_string("data_dir", './processed_data', "Директория с обработанными данными NSD")
